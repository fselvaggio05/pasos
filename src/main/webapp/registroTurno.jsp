          ...
          <c:if test="${mensaje !=null }">
          	<div class="modal fade" id="mensajeOK" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
               	<div class="modal-dialog">
                                                    ...
                                                    <div class="col-6">
                                                        <form action="registroTurno" method="post" id="practica">
                                                            <input type="hidden" value="buscarProfesional"
                                                                name="operacion">
                                                            <c:if test="${not empty idPrescripcion}">
                                                                <input type="hidden" value="${idPrescripcion}"
                                                                    name="idPrescripcion">
                                                            </c:if>
                                                            <select class="form-select mb-2" name="practicas"
                                                                onchange="document.getElementById('practica').submit()">
                                                                <option value="0">Seleccione una Practica</option>
                                                                <c:forEach var="pr" items="${practicas}">
                                                                    <c:choose>
                                                                        <c:when
                                                                            test="${pr.id_practica eq practicaSeleccionada}">
                                                                            <option value="${pr.id_practica}" selected
                                                                                disabled>${pr.descripcion}</option>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <option value="${pr.id_practica}">
                                                    ...
                                                    <c:if test="${not empty practicaSeleccionada}">
                                                        <div class="col-6">
                                                            <form action="registroTurno" method="post" id="profesional">
                                                                <input type="hidden" value="buscarTurnos"
                                                                    name="operacion">
                                                                <c:if test="${not empty idPrescripcion}">
                                                                    <input type="hidden" value="${idPrescripcion}"
                                                                        name="idPrescripcion">
                                                                </c:if>
                                                                <input type="hidden" name="practicaSeleccionada"
                                                                    value="<%= request.getAttribute("practicaSeleccionada") %>">
                                                                <select class="form-select mb-2" name="profesional"
                                                                    onchange="document.getElementById('profesional').submit()">
                                                                ...
                                                                <td>
                                                                    <c:if test="${not empty idPrescripcion}">
                                                                        <a href='#'
                                                                            ...
                                                                            id="botonRegistrarTurno-${tur.id_turno}"
                                                                            idTurno="${tur.id_turno}"
                                                                            idPrescripcion="${idPrescripcion}"
                                                                            fecha_t="${tur.fecha_t}"
                                                                            hora_t="${tur.hora_t}">Reservar</a>
                                                                    </c:if>
                                                                    <c:if test="${empty idPrescripcion}">
                                                                        <a href='#' class="btn btn-success btn-sm"
                                                                            data-bs-toggle='modal'
                                                                            data-bs-target='#buscarPaciente'
                                                                            id="botonBuscarPaciente-${tur.id_turno}"
                                                                            idTurno="${tur.id_turno}">Reservar</a>
                                                                    </c:if>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                    ...
                    <!--VENTANA MODAL "BUSCAR PACIENTE" -->
                    <div class="modal fade" id="buscarPaciente" tabindex="-1" aria-labelledby="modalBuscarPacienteLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <form id="formBuscarPaciente" action="registroTurno" method="post">
                                        ...
                                        <input type="hidden" name="idTurnoHidden" id="idTurnoHidden">
                                        <input type="number" name="dniPaciente" placeholder="Buscar Paciente"
                    ...
                    <!--VENTANA MODAL "RESERVAR TURNO" -->
                    <div class="modal fade" id="registrarTurno" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Confirmar reserva de turno
                                    </h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <form action="registroTurno" method="post">
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" name="turno" id="turno" value="${turno}">
                                        <input type="hidden" name="idTurnoHidden" id="idTurnoHidden">
                                        <input type="hidden" name="dniPaciente" id="dniPaciente"
                                            value="${paciente.dni}">
                                        <div class="mb-3">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:when test="${not empty prescripcion}">
                                                    <c:out
                                                        value="${prescripcion.paciente.apellido} ${prescripcion.paciente.nombre}">
                                                    </c:out>
                                                </c:when>
                                            </c:choose>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:when test="${not empty prescripcion}">
                                                    <input type="hidden" value="${prescripcion.paciente.nro_afiliado}"
                                                        name="nroAfiliado">
                                                    <c:out value="${prescripcion.paciente.nro_afiliado}"></c:out>
                                                </c:when>
                                            </c:choose>

               ...
               <div class="row mt-1">
                   ...
                   <div class="col-9">
                       ...
                       <div class="container ">
                                       ...
                                       <select class="form-select mb-2" name="profesional">
                                           <c:forEach var="prof" items="${profesionales}">
                                               <c:choose>
                                                   ...
                                                   <c:otherwise>
                                                       <option value="<c:out value="${prof.matricula}">
                                                           </c:out>"><c:out value="${prof.apellido} , ${prof.nombre}">
                                                           </c:out>
                                                       </option>
                                                   </c:otherwise>
                                               </c:choose>
                           ...
                           <div class="row">
                               <div class="col-4 ">
                                   <label class="fs-6 fst-italic fw-bold mb-3" for="">DNI paciente</label>
                           
                                   <form action="registroTurno" method="post">
                                       <input type="hidden" value="buscarPaciente" name="operacion">
                                       <c:choose>
                                           <c:when test="${dniPacienteBuscado!=null}">
                                               <input type="number" class="form-control mb-2" name="dniPaciente" value="<c:out value="
                                                   ${dniPacienteBuscado}"></c:out>">
                                           </c:when>
                                           <c:otherwise>
                                               <input type="number" class="form-control mb-2" name="dniPaciente">
                                           </c:otherwise>
                                       </c:choose>
...
<!--                                                        id="horaTurno"> -->
                                                   ...
                                                   <td>
                                                       <a href='#' class="btn btn-success btn-sm" data-bs-toggle='modal'
                                                           data-bs-target='#registrarTurno' idTurno="${tur.id_turno}"

...
<html lang="en">
	...
	<body>
                            	...
                            	<tbody>
                            		<c:forEach var="tur" items="${turnos}">
										<tr>
											...
											<td><a href="#" class="btn btn-success btn-sm" idTurno="${tur.id_turno}" apellidoProfesional="${tur.getHorario().getProfesional().getApellido()}" descPractica="${tur.getHorario().getPractica().getDescripcion()}" fecha_turno="${tur.fecha_t}" hora_turno="${tur.hora_t}" data-bs-toggle="modal" data-bs-target="#registroAsistencia">Registrar</a></td>
										</tr>										
									</c:forEach>
                            	</tbody>
                        	</table>
		...
		<div class="modal fade" id="registroAsistencia" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            	...
            	<div class="modal-content">
                    ...
                    <div class="modal-body">
                    	<form action="registroAsistencia" method="post">
                            ...
                            <input type="hidden" name="paciente" id="paciente" value="${paciente.dni}">
                            <div>
